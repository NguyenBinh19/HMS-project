...
public enum ErrorCode {
    ...
    BOOKING_NOT_CHECKED_IN(2221, "Booking must be in CONFIRMED or IN_HOUSE status to check out", HttpStatus.BAD_REQUEST),
    ...
    //check-in (UC-052)
    CHECKIN_NOT_ALLOWED(2240, "Booking must be CONFIRMED to check in", HttpStatus.BAD_REQUEST),
    ...
    //no-show (UC-053)
    NOSHOW_NOT_ALLOWED(2250, "Only CONFIRMED bookings can be marked as no-show", HttpStatus.BAD_REQUEST),
