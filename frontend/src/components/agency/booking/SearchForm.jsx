        ...
        <div className={`${
            ...
            <div className="flex-1">
                ...
                <div className="flex items-center bg-white rounded-lg px-3 py-2.5 border border-slate-200 focus-within:border-blue-500 transition-all">
                    ...
                    <input type="text" placeholder="Điểm đến" className="bg-transparent outline-none text-slate-700 text-sm w-full" />
                </div>
            </div>
            ...
            <div className={isHero ? "flex-1" : "w-[250px]"}>
                ...
                <div className="flex items-center bg-white rounded-lg px-3 py-2.5 border border-slate-200 focus-within:border-blue-500">
                    ...
                    <input type="text" placeholder="Th 2 26 thg 1 2026 - Th 4 28 thg 1 2026" className="bg-transparent outline-none text-slate-700 text-sm w-full" />
                </div>
            </div>
            ...
            <div className={isHero ? "flex items-end" : ""}>
                <button className="bg-[#0061E5] hover:bg-blue-700 text-white font-bold px-8 py-2.5 rounded-lg flex items-center justify-center gap-2 transition-colors uppercase text-sm h-[42px]">
