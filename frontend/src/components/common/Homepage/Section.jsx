            ...
            <section className="relative min-h-[650px] flex flex-col items-center justify-center text-center px-4 py-12">
                ...
                <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col items-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mb-12">
                        ...
                        <button onClick={() => handleRoleNav("/hotel")} className="flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl bg-[#F36F21] hover:bg-[#d85e17] text-white font-bold transition-all active:scale-95 shadow-lg">
