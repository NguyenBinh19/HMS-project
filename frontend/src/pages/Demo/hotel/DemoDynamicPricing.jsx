                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="flex flex-col h-full">
                            ...
                            <p className="text-[13px] text-gray-500 mb-4">Điều khiển toàn bộ hệ thống định giá tự động</p>
                        ...
                        <div className="flex flex-col h-full md:border-l md:border-gray-100 md:pl-8">
                            ...
                            <div className="mt-auto">
                                <select
                                    ...
                                    className="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-lg p-2.5 outline-none font-medium cursor-pointer hover:bg-gray-100 transition-colors"
                                >
